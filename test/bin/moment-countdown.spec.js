...
(function() {
  var assertEqual, countdown, moment, ref, ref1;

  moment = (ref = typeof require === "function" ? require("moment") : void 0) != null ? ref : this.moment;

  countdown = (ref1 = typeof require === "function" ? require("countdown") : void 0) != null ? ref1 : this.countdown;
  ...
  describe("moment.countdown()", function() {
    ...
    it("returns a default countdown with no options", function() {
      return assertEqual("8 years, 4 months, 20 days, 5 hours and 15 seconds", start.countdown(end).toString());
    });
    return it("returns a specific format when options are provided", function() {
      ...
      return assertEqual("100 months and 29100.25 minutes", start.countdown(end, countdown.MONTHS | countdown.MINUTES | countdown.SECONDS, 2, 2).toString());
    });
  });
